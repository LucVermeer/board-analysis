...
const documents: Documents = {
  ...
  '\n  query GetAnalyzedBetaVideos($boardType: String!, $climbUuid: String!, $layoutId: Int!) {\n    analyzedBetaVideos(boardType: $boardType, climbUuid: $climbUuid, layoutId: $layoutId) {\n      id\n      provider\n      providerClimbId\n      boardType\n      boardLayout\n      sourceAccount\n      postKey\n      postUrl\n      mediaItemKey\n      mediaItemIndex\n      mediaItemCount\n      segmentKey\n      evidenceScope\n      resolutionScope\n      assignmentState\n      assignmentMethod\n      uncertaintyReasons\n      isDefinitive\n      hasMoveAnalysis\n      candidateClimbs {\n        normalizedClimbId\n        climbId\n        climbName\n        boardLayout\n        grades\n        angles\n      }\n      climb {\n        id\n        normalizedId\n        name\n        grade\n        angle\n        boardLayout\n        setterUsername\n      }\n      playbackPath\n      movesPath\n    }\n  }\n':
    types.GetAnalyzedBetaVideosDocument,
  '\n  query GetAnalyzedBetaNavigation($boardType: String!, $climbUuid: String!, $layoutId: Int!) {\n    analyzedBetaNavigation(boardType: $boardType, climbUuid: $climbUuid, layoutId: $layoutId) {\n      confirmedVideoCount\n      analyzedVideoCount\n      moves {\n        moveKey\n        targetHolds {\n          key\n          col\n          row\n        }\n        videoCount\n        confirmedVideoCount\n        handCounts {\n          hand\n          count\n        }\n      }\n    }\n  }\n':
    types.GetAnalyzedBetaNavigationDocument,
  '\n  query GetAnalyzedBetaMoveAttempts($boardType: String!, $climbUuid: String!, $layoutId: Int!, $moveKey: String!) {\n    analyzedBetaMoveAttempts(boardType: $boardType, climbUuid: $climbUuid, layoutId: $layoutId, moveKey: $moveKey) {\n      moveKey\n      videoId\n      sourceAccount\n      localMoveId\n      localOrdinal\n      targetHolds {\n        key\n        col\n        row\n      }\n      transitions {\n        hand\n        source {\n          key\n          col\n          row\n        }\n        destination {\n          key\n          col\n          row\n        }\n        sourceAssumed\n      }\n      playbackStartS\n      playbackEndS\n      confidence\n      warnings\n      occurrenceCount\n    }\n  }\n':
    types.GetAnalyzedBetaMoveAttemptsDocument,
  '\n  query GetBetaLinks($boardType: String!, $climbUuid: String!) {\n    betaLinks(boardType: $boardType, climbUuid: $climbUuid) {\n      climbUuid\n      link\n      foreignUsername\n      angle\n      thumbnail\n      isListed\n      createdAt\n      tickUuid\n      boardId\n    }\n  }\n':
  ...
  '\n  query GetPrivateAttemptVideos($climbUuid: String!, $layoutId: Int!, $angle: Int!) {\n    privateAttemptVideos(climbUuid: $climbUuid, layoutId: $layoutId, angle: $angle) {\n      uuid\n      tickUuid\n      boardType\n      climbProvider\n      climbUuid\n      layoutId\n      angle\n      isMirror\n      mimeType\n      byteSize\n      durationMs\n      recordedAt\n      createdAt\n      playbackPath\n    }\n  }\n':
    types.GetPrivateAttemptVideosDocument,
  '\n  query GetClimbProposals($input: GetClimbProposalsInput!) {\n    climbProposals(input: $input) {\n      proposals {\n        uuid\n        climbUuid\n        boardType\n        angle\n        proposerId\n        proposerDisplayName\n        proposerAvatarUrl\n        type\n        proposedValue\n        currentValue\n        status\n        reason\n        resolvedAt\n        resolvedBy\n        createdAt\n        weightedUpvotes\n        weightedDownvotes\n        requiredUpvotes\n        userVote\n        climbName\n        frames\n        layoutId\n        climbSetterUsername\n        climbDifficulty\n        climbQualityAverage\n        climbAscensionistCount\n        climbDifficultyError\n        climbBenchmarkDifficulty\n        climbIsNoMatch\n      }\n      totalCount\n      hasMore\n    }\n  }\n':
