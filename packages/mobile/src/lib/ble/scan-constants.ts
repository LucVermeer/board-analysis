// Shared BLE scan timing constants. Kept in one place so the two platform
// adapters (native iOS, react-native-ble-plx) and their tests can't drift apart.
// Mirrors packages/web/app/lib/ble/scan-constants.ts.
