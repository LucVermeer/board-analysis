...
| `BOARDSESH_ATTEMPT_VIDEO_DIR` | `.boardsesh/private-attempt-videos`                               | Persistent private-attempt media directory             |
| `BOARDSESH_ANALYSIS_URL`      | unset                                                             | Local provenance/analysis service base URL             |

Private recording storage, retry behavior, privacy boundaries, and the
analysis adapter are documented in [Private Attempt Videos](../../docs/private-attempt-videos.md).
